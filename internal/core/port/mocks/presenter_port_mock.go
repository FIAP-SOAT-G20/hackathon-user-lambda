...
//
//	mockgen -source=internal/core/port/presenter_port.go -destination=internal/core/port/mocks/presenter_port_mock.go
//
...
func (m *MockPresenter) Present(arg0 any) ([]byte, error) {
	m.ctrl.T.Helper()
